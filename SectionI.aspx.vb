        ...
        Using cmdinsert As New SqlCommand(SQLinsert, cnn)
            Using cmdexist As New SqlCommand(SQLexist, cnn)
                ...
                Else
                    ...
                    MapTextValueField(PrivateRoom, "@PrivateRoom", "0")
                    MapTextValueField(SemiPrivateRoom, "@SemiPrivateRoom", "0")
                    MapTextValueField(ResEmpNurs, "@ResEmpNurs", "0.0")
                    MapTextValueField(ResStaffNurs, "@ResStaffNurs", "0.0")
                    MapTextValueField(ResEmpNursPract, "@ResEmpNursPract", "0.0")
                    MapTextValueField(ResStaffNursPract, "@ResStaffNursPract", "0.0")
                    MapTextValueField(ResEmpSS, "@ResEmpSS", "0.0")
                    MapTextValueField(ResStaffSS, "@ResStaffSS", "0.0")
                    MapTextValueField(ResEmpHHA, "@ResEmpHHA", "0.0")
                    MapTextValueField(ResStaffHHA, "@ResStaffHHA", "0.0")
                    MapTextValueField(ResEmpPhy, "@ResEmpPhy", "0.0")
                    MapTextValueField(ResStaffPhy, "@ResStaffPhy", "0.0")
                    MapTextValueField(ResEmpPhyVol, "@ResEmpPhyVol", "0.0")
                    MapTextValueField(ResStaffPhyVol, "@ResStaffPhyVol", "0.0")
                    MapTextValueField(ResEmpChap, "@ResEmpChap", "0.0")
                    MapTextValueField(ResStaffChap, "@ResStaffChap", "0.0")
                    MapTextValueField(ResEmpOth, "@ResEmpOth", "0.0")
                    MapTextValueField(ResStaffOth, "@ResStaffOth", "0.0")
                    MapTextValueField(ResEmpNon, "@ResEmpNon", "0.0")
                    MapTextValueField(ResStaffNon, "@ResStaffNon", "0.0")
                    MapTextValueField(ResEmpTotal, "@ResEmpTotal", "0.0")
                    MapTextValueField(ResStaffTotal, "@ResStaffTotal", "0.0")
                    MapTextValueField(ResFTETotal, "@ResFTETotal", "0.0")
